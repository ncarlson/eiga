...
return ffi.load( jit.os == "OSX" and "runtime/OSX/libPHYSFS.dylib" or
                 jit.os == "Linux" and "runtime/Linux/libphysfs.so" or
                 jit.os == "Windows" and "runtime/Windows/physfs.dll")
